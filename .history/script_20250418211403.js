...
document.querySelectorAll('.apri-album').forEach(btn => {
  btn.addEventListener('click', () => {
    ...
    // API Pexels - Sostituisci con la tua chiave API
    const API_KEY = 'YOUR_PEXELS_API_KEY'; // Sostituisci con la tua chiave API di Pexels
    const query = 'fashion'; // Query per ottenere immagini di moda
    ...
    .then(data => {
      ...
      data.photos.forEach(photo => {
        ...
        col.innerHTML = `
          <img src="${photo.src.medium}" class="img-fluid rounded shadow-sm" alt="${photo.alt}" title="Ph: ${photo.photographer}">
        `;
        row.appendChild(col);
      });
