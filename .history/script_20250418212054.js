      ...
      fetch('https://fakestoreapi.com/products?limit=6')
        ...
        document.querySelectorAll('.apri-album').forEach(btn => {
          btn.addEventListener('click', () => {
            ...
            const API_KEY = '1J5XZG6HEjef4TKrOiBtmHWoMJVdLRUIxplL9GJzFHBeI64zgRPny53m';  // Assicurati che questa sia corretta
            ...
            .then(r => r.json())
            .then(data => {
              console.log("Dati ricevuti:", data);  // Aggiungi questo log per vedere cosa ricevi
              if (data && data.photos) {
            ...
            .catch(err => {
              ...
              console.error(err);  // Log dell'errore per capire cosa è successo
            });
          });
        });
